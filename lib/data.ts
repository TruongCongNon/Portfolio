...
export const projects: Project[] = [
  {
    ...
    detail: [
      "Designed and developed a responsive user interface using NextJS and Tailwind CSS.",
      "Built CRUD APIs for rooms, tenants, contracts, invoices, and room status management using NodeJS and ExpressJS.",
      "Designed a MySQL database to store room information, tenant profiles, rental contracts, payment history, and room availability status.",
    ...
    image,
    codeUrl: "https://github.com/29ieH/hostel-management-app",
    time: "5/04/2026 - now",
    status: false,
    demo: false,
  },
